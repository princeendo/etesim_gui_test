...
class SubFrame(tk.Frame):
    def __init__(self, root, url=None):
        ...
        self.browser_frame = BrowserFrame(self, self.navigation_bar, url=url)
...
class BrowserFrame(tk.Frame):
    ...
    def __init__(self, master, navigation_bar=None, url=None):
        ...
        self.bind("<FocusIn>", self.on_focus_in)
        self.bind("<FocusOut>", self.on_focus_out)
        self.bind("<Configure>", lambda _: self.on_configure(url))
        self.focus_set()
    ...
    def embed_browser(self, url=None):
        ...
        url = "http://www.google.com" if url is None else url
